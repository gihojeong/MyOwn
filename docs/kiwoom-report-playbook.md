...
- **KOSPI200 선물·베이시스·미결제약정, CME 야간선물** — 키움 REST OpenAPI에는 파생 시세가
  아예 없다(국내주식·미국주식뿐, `spec_groups` 확인). ECOS에도 없다. 이것만 웹으로 조사하라.
- 지수의 정확한 종가(S&P500·나스닥종합 포인트), 금·WTI의 절대 가격 — 위 ETF 항목 참고.
  다만 **EWY 프리미엄이 CME 야간선물의 상당 부분을 대신한다**(위 연립 절 참고).
